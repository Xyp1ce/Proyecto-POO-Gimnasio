...
public class Gimnasio implements Serializable
{
	...
	// ATRIBUTOS
	private String nombre = "Gimnasio";
	...
	public static void main(String[] args)
	{
		...
		System.out.println(gimnasio);   // impresion en consola
		MenuPrincipal.menu();		   // iniciar menu principal
	}
	...
	{ // TRUE SI EXISTE EL EMPLEADO, FALSE SI NO
	...
	{ // TRUE SI EXISTE EL CLIENTE, FALSE SI NO
		if (sucursales == null)
			return false;
		for (Sucursal sucursal : sucursales)
		{
